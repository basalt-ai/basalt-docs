...
const resources = [
  {
    ...
    name: 'Prompts',
    description:
      'Learn about the prompt model and how to retrieve them and their specific versions programmatically.',
    icon: UserIcon,
    pattern: {
      y: 16,
      squares: [
...
function ResourcePattern({ mouseX, mouseY, ...gridProps }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#D7EDEA] to-[#fff7f3] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#202D2E] dark:to-[#303428]"
        style={style}
      />
      <motion.div
